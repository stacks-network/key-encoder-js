...
test('testECPrivateKey', function(t) {
    ...
    t.equal(privateKeyPEM, openSSLPrivateKeyPEM, 'encoded private key PEM should match the one generated by OpenSSL')
...
test('testECPublicKey', function(t) {
    ...
    t.equal(publicKeyPEM, openSSLPublicKeyPEM, 'encoded public key PEM should match the one generated by OpenSSL')
})
...
test('testSECP256k1PrivateKey', function(t) {
    ...
    t.equal(privateKeyPEMCompact, openSSLPrivateKeyPEMCompact, 'compact encoded private key PEM should match the one generated by OpenSSL')
